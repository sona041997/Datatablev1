...
<main className='m-5 p-5 xl:mx-w-4xl ml-5 mb-5 xl:mx-auto bg-white rounded shodow' style={{width:600 , margin:"auto"}}>
  {showInvoice ? (
<>
...
className=' mt-5 bg-blue-500 text-white font-bold py-2 px-8 rounded shodow border-2 border-blue-500 
...
<textarea  name= "notes" rows="10" cols="30" placeholder='Additionl notes to client
'value={notes} onChange={(e)=> setNotes(e.target.value)}></textarea>


<button 
onClick={()=> setShowInvoice (true)} 
className='bg-blue-500 text-white font-bold py-2 px-8 rounded shodow border-2 border-blue-500 
hover:bg treansparent hover:text-blue-500
transition-all duration-300'> 
